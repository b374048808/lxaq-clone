...
<div class="modal-body">
    ...
    <?php Pjax::begin(); ?>
    <div class="row">
        <?= Html::beginForm(['ajax-edit', 'simple_id' => $simple_id], 'get', ['data-pjax' => '', 'class' => 'form-inline']); ?>
        <?= Html::input('text', 'title', Yii::$app->request->get('title'), ['class' => 'form-control']) ?>
        <?= Html::dropDownList('type', $selection = Yii::$app->request->get('type'), $items = array_merge([0 => '全部'],PointEnum::getMap()), $options = ['class' => 'form-control']) ?>
...
<?php
$url = Url::to(["add-points", 'simple_id' => $simple_id]);
$js = <<<JS
