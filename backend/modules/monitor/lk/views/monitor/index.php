...
<div class="row">
    <div class="col-md-2 col-sm-6 col-xs-12">
        <div class="info-box">
            <div class="info-box-content p-md">
                <span class="info-box-number"><i class="icon ion-person-stalker blue"></i> <?= $memberCount ?>/65</span>
                <span class="info-box-text">倾斜点位(个)</span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
    ...
    <div class="col-md-12 col-xs-12">
        <div class="box box-solid">
            <div class="box-header">
                ...
                <h3 class="box-title">倾斜</h3>
            </div>
            <?= \common\widgets\echarts\Echarts::widget([
                'config' => [
                    'server' => Url::to(['angle-point-between-count']),
                    'height' => '315px'
                ]
            ]) ?>
            <!-- /.box-body -->
    ...
    <div class="col-md-6 col-xs-12">
        <div class="box box-solid">
            <div class="box-header">
                <i class="fa fa-circle blue" style="font-size: 8px"></i>
                <h3 class="box-title">裂缝</h3>
            </div>
            <?= \common\widgets\echarts\Echarts::widget([
                'config' => [
                    'server' => Url::to(['cracks-point-between-count']),
                    'height' => '315px'
                ]
            ]) ?>
            <!-- /.box-body -->
    ...
    <div class="col-md-6 col-xs-12">
        <div class="box box-solid">
            <div class="box-header">
                <i class="fa fa-circle blue" style="font-size: 8px"></i>
                <h3 class="box-title">沉降</h3>
            </div>
            <?= \common\widgets\echarts\Echarts::widget([
                'config' => [
                    'server' => Url::to(['sink-point-between-count']),
                    'height' => '315px'
                ]
            ]) ?>
            <!-- /.box-body -->
