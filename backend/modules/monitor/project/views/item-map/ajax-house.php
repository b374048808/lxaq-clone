 ...
 * @Date: 2021-09-16 15:22:04
 * @LastEditors: Xjie<374048808@qq.com>
 * @LastEditTime: 2021-11-02 15:27:25
 * @Description: 
 */
...
<div class="modal-body">
    ...
    <?php Pjax::begin(); ?>
    <div class="row">
        <?= Html::beginForm(['ajax-house', 'id' => $id], 'get', ['data-pjax' => '', 'class' => 'form-inline']); ?>
...
<?php
$url = Url::to(["/monitor-project/item-map/add-house", 'id' => $id]);
$js = <<<JS
