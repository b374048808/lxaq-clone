 ...
 * @LastEditTime: 2022-02-21 17:42:04
 * @Description: 
 */
    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li><a href="<?= Url::to(['point-list', 'id' => $id], $schema = true) ?>">监测点</a></li>
                <li><a href="<?= Url::to(['/monitor-project/house/data-chart', 'id' => $id], $schema = true) ?>">数据曲线</a></li>
                <li class="active"><a href="#">报告</a></li>
                <li class="pull-right">
                    <?= Html::create(['/monitor-project/report/ajax-edit', 'pid' => $id], '添加', [
                        'data-toggle' => 'modal',
                ...
                <?= GridView::widget([
                    ...
                    'columns' => [
                        ...
                        [
                            'attribute' => 'file',
                            'value' => function ($que) {
                                $html = Html::a('<i class="fa fa-file-word-o" style="font-size:18px"></i> ', $que['file'], $options = [
                                    'download' => 'download'
                                ]);
                                return $html;
                            },
