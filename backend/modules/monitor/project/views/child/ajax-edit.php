 ...
 * @Date: 2021-04-08 10:52:16
 * @LastEditors: Xjie<374048808@qq.com>
 * @LastEditTime: 2021-05-07 09:30:42
 * @Description: 
 */
...
<div class="modal-header">
    ...
    <h4 class="modal-title">关联房屋</h4>
</div>
<div class="modal-body">

    <?php Pjax::begin(); ?>
    <div class="row">
        <?= Html::beginForm(['ajax-edit', 'rule_id' => $rule_id], 'get', ['data-pjax' => '', 'class' => 'form-inline']); ?>
...
<?php
$url = Url::to(["add-point", 'rule_id' => $rule_id]);
$js = <<<JS
