 ...
 * @LastEditTime: 2021-05-06 14:45:07
 * @Description: 
 */
        ...
        [
            ...
            'buttons' => [
                'view' => function ($url, $model, $key) {
                    return Html::linkButton(['view', 'id' => $model->id,'type' => PointEnum::SINK], '查看', [
                        'data-toggle' => 'modal',
                        'data-target' => '#ajaxModalLg',
                    ]);
                },
                'edit' => function ($url, $model, $key) {
                    return Html::edit(['ajax-edit', 'id' => $model->id,'type' => PointEnum::SINK], '编辑', [
                        'data-toggle' => 'modal',
                        'data-target' => '#ajaxModalLg',
                    ]);
                },
