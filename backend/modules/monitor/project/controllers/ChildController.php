...
use common\models\monitor\project\rule\Child;
...
class ChildController extends BaseController
{
     ...
     */
    public function actionAjaxEdit($house_id)
    {
        $request = Yii::$app->request;
        ...
        $query = Point::find()
            ->where(['not in', 'id', Child::getPointMap($rule_id)])
            ->andWhere(['pid' => $house_id])
    ...
    public function actionAddPoint()
    {
        ...
        return Child::addPoints($rule_id, $data);
    }
