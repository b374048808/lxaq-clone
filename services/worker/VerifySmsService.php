...
use common\queues\VerifySmsJob;
 ...
 */
class VerifySmsService extends Service
{
    /**
     * 消息队列
     *
     ...
     */
    public function send($mobile,$manager, $item, $usage, $member_id = 0)
    {
        ...
        return $this->realSend($mobile,$manager, $item, $usage, $member_id = 0, $ip);
    }
     ...
     * @throws UnprocessableEntityHttpException
     */
    public function realSend($mobile, $manager, $item, $usage = 'manager-verify', $member_id = 0, $ip = 0)
    {
