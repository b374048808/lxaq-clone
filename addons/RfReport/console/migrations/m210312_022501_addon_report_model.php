...
class m210312_022501_addon_report_model extends Migration
{
    public function up()
    {
        /* 取消外键约束 */
        ...
        $this->createTable('{{%addon_report_model}}', [
            ...
            'cate_id' => "int(10) NULL DEFAULT '0' COMMENT '模版类型'",
            'title' => "varchar(50) NOT NULL COMMENT '标题'",
            'file' => "varchar(100) NOT NULL COMMENT '模版地址'",
            'status' => "tinyint(4) NULL DEFAULT '1' COMMENT '状态[-1:删除;0:已使用;1启用]'",
